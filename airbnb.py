...
if selected == "Home":
    ...
    col1.markdown("##### :green[Domain] : Travel Industry, Property Management and Tourism")
    col1.markdown("##### :green[Technologies used] : Python, Pandas, Plotly, Streamlit, MongoDB")
    col1.markdown("##### :green[Overview] : To analyze Airbnb data using MongoDB Atlas, perform data cleaning and preparation, develop interactive visualizations ")
    
# OVERVIEW PAGE
if selected == "Overview":
    tab1,tab2 = st.tabs(["$\small 📝 RAW DATA $", "$\small🚀 INSIGHTS $"])
    with tab1:
